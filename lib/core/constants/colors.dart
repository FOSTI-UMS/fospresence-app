...
Color get primaryColor => const Color(0xFF01BD6D);
Color get appLightBgColor => const Color.fromARGB(255, 235, 241, 243);
// Color get appLightBgColor => const Color(0xFF24292d);
